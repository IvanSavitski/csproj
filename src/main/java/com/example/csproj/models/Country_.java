package com.example.csproj.models;
...
public class Country_ implements Serializable {
    ...
    /*
    @Column(value = "max(country_languages)")
    private String countryLanguages; // Предполагается, что это текстовое представление списка языков
